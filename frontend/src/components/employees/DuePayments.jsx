                    ...
                    <tbody className="divide-y divide-gray-1700">
                        {data.map((item, index) => (
                            <tr key={index} className=' cursor-pointer hover:bg-sclaimed-100'>
                                ...
                                <td>
                                    <button className='w-[40px] ml-4 h-[30px] hover:bg-[#50B426] border-[2px] border-[#50B426] border-solid hover:text-white rounded-md bg-transparent text-[#50B426]'>Pay</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
