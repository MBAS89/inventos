...
export const OuterInvoiceBasicInfo = ({data}) => {
                        ...
                        {data ? 
                            ...
                            <div className='p-4 border-2 border-[#50B426] rounded-lg w-[60%]'>
                                ...
                                <div className='flex gap-5 mt-4 items-center'>
                                    <div className=' bg-[#50B426] rounded-full w-[60px] h-[60px] p-1'>
                                        <img src={data.supplier.image} className='rounded-full w-full h-full' alt={`customer ${data.supplier.supplier_name} image`} />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p className='font-bold'>{data.supplier.suppliers_type.type_name}</p>
                                    </div>
                                </div>
                            </div>
                            :
                            <div className='p-4 border-2 border-[#50B426] rounded-lg w-[60%]'>
                                ...
                                <div className='flex gap-5 mt-4 items-center justify-center'>
                                    <div className=' text-gray-400 mt-4 font-bold italic'>No Supplier Selected For Invoice</div>
                                </div>
                            </div>
                        :
