...
//components
import { InventoryAnalyticsBarChart } from './InventoryAnalyticsBarChart'

export const InventoryVisualAnalytics = () => {
    return (
        <div className='bg-white h-[40rem] w-[65%] rounded-2xl drop-shadow-sm p-8 mb-10'>
            <div className='flex justify-between items-center'>
                <h2 className='font-bold text-[1.6rem]'>Inventory Analytics</h2>
