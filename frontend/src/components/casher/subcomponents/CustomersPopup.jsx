...
export const CustomersPopup = ({setShowCustomersList}) => {
        ...
        <section className="absolute left-3 top-16 w-[95%] z-10 bg-gray-100 overflow-hidden border-2 border-solid border-gray-200 rounded-lg shadow-2xl h-[25rem]">
            <div className='flex justify-between items-center px-4 py-4'>
                <div className="relative">
                    <input type="text" id="Search" placeholder="Search Customer" className="w-[300px] rounded-md border-gray-200 py-2.5 ps-3 pe-5 shadow-sm sm:text-sm"/>
