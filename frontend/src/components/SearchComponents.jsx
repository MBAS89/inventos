...
export const SearchComponents = ({ placeholder, actionName, setOpenPopup, setsearchQuery, searchQuery }) => {
  ...
  return (
    <div className='flex justify-between items-center p-4'>
      <div className="relative w-[500px]">
        <input value={searchQuery} onChange={(e) => setsearchQuery(e.target.value)} type="text" id="Search" placeholder={placeholder} className="w-[500px] outline-none rounded-md border-[#50B426] border-[2px] border-solid py-2 ps-3 pe-5 shadow-sm sm:text-sm"/>
