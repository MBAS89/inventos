...
export const CustomersTable = ({ headItems }) => {

    const data = [
        {
            image:"https://img.icons8.com/dusk/64/son-goku.png",
            name:"Ilie Corina",
                    ...
                    <tbody className="divide-y divide-gray-200">
                        {data.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td className="px-4 py-2 font-bold text-[#4454DC]">${item.totalDebt}</td>
                                <td className="px-4 py-2 text-orange-400 font-bold">{item.discount}</td>
