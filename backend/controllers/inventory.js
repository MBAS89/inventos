...
exports.removeCategory = async (req, res, next) => {
   ...
   try {
        ...
        */
        ...
        const categoryResponse = await db.query("DELETE FROM categories where category_id = $1", [categoryId])
        ...
        if(!categoryResponse.rows[0]){
            return next(new ErrorResponse("Something Went Wrong OR Category Not Found", 500));
        }
