...
const storage = new CloudinaryStorage({
    ...
    params: {
        folder: (req, file) => {
            ...
            return `stores/${req.query.storeDashCreate ? req.body.store_name : req.authData.store_name ? req.authData.store_name : req.body.storeName}/${req.query.storeDashCreate ? 'info_images' : req.body.folderName}`;
        },
