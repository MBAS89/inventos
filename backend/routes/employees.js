...
const { addEmployee, editEmployee, removeEmployee, readEmployees, readSingleEmployee, editEmployeeRole, editEmployeeJobDetails } = require('../controllers/employees/employee')
//ROLES CONTROLLERS
